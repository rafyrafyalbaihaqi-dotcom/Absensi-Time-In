...
const adminDashboard = {
    ...
    renderRecentActivity() {
        ...
        const activities = [
            { user: 'Ibnu Syihab', action: 'Clock In', time: '5 menit yang lalu', avatar: 'https://ui-avatars.com/api/?name=Ibnu&background=3B82F6&color=fff' },
            { user: 'Rafi Al Baihaqi', action: 'Mengajukan Cuti', time: '15 menit yang lalu', avatar: 'https://ui-avatars.com/api/?name=Rafi&background=10B981&color=fff' },
            { user: 'Anisa Rizky Aulia', action: 'Mengisi Jurnal', time: '30 menit yang lalu', avatar: 'https://ui-avatars.com/api/?name=Anisa&background=F59E0B&color=fff' },
            { user: 'Faisal Haqi', action: 'Clock Out', time: '1 jam yang lalu', avatar: 'https://ui-avatars.com/api/?name=Faisal&background=EF4444&color=fff' },
            { user: 'Makhbub Khumaidi', action: 'Izin Sakit', time: '2 jam yang lalu', avatar: 'https://ui-avatars.com/api/?name=Makhbub&background=8B5CF6&color=fff' }
        ];
